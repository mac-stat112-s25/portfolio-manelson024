...
- It lists the categories in alphabetical order rather than from low to high. 
...
- We would have to calculate the typical Republican support in each state. 
- We would have to manually type out a meanigful order for all 50 states. 
